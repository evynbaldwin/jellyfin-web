...
const UserProfiles = () => {
    ...
    useEffect(() => {
        ...
        (page.querySelector('#btnAddTenants') as HTMLButtonElement).addEventListener('click', onAddUserClick);

        return () => {
            page.removeEventListener('click', onPageClick);
            (page.querySelector('#btnAddTenants') as HTMLButtonElement).removeEventListener('click', onAddUserClick);
        };
            ...
            <div ref={element} className='content-primary'>
                <div className='verticalSection'>
                    <SectionTitleContainer
                        title={globalize.translate('HeaderTenants')}
                        isBtnVisible={true}
                        btnId='btnAddTenants'
                        btnClassName='fab submit sectionTitleButton'
                        btnTitle='ButtonAddTenant'
                        btnIcon='add'
                    />
                </div>
